#!/usr/bin/env bash
# auth_compile_challenge.sh - Validates Auth module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.auth"
if grep -q "^module digital.vasic.auth$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.auth"
else
