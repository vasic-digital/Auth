# Auth - Generic, reusable Go module for authentication and authorization.
...
challenge:
	../challenges/scripts/auth_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Auth - Generic, reusable Go module for authentication and authorization."
	@echo ""
	@echo "Build & Test:"
